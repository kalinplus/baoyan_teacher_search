...
- 清华大学 自动化系：`h4.h4s1`（当前抓取的是博导名单页 `bdmd.htm`，仅含教授；副教授与研究员需 JS 点击加载，暂未覆盖）
...
- 北京大学 软件工程国家工程研究中心：`<table class="fedd">` 结构化提取 `name/title/email/interests`，少数含 `Webpage` 链接
...
- 浙江大学 软件学院：~98
- 上海创智学院 学院导师：73
- 北京大学 软件工程国家工程研究中心：17（列表页直接提取，大多数教师无独立主页）
- 中国人民大学 高瓴人工智能学院：26
- 南京大学 智能科学与技术学院：52
